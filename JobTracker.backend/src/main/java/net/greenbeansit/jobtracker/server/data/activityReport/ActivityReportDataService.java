...
public interface ActivityReportDataService
{
	...
	/**
	 * Retrieves all reports. Should only be used when debugging (massive amount of data).
	 ...
	 * @param reportId id of the requested report
	 ...
	 * @param from including this date
	 * @param to also including this date
